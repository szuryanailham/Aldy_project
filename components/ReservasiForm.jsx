...
import photo from "@/public/assets/images/reservasi.webp";
...
const ReservasiForm = () => {
  return (
    <section id="Reservasi" className="w-full h-fit mt-5">
      ...
      {/* Content Wrapper */}
      <div className="max-w-screen-lg w-full h-fit mx-auto flex flex-col md:flex-row bg-[#393f17] shadow-lg rounded-lg p-10 gap-5">
        {/* Left Side */}
        <div className="w-full md:w-1/2 mx-auto">
          <Image src={photo} className="mx-auto mb-5 w-[277px] h-[258px] md:w-full md:h-[300px]" alt="Photo" />
          <h1 className="w-full md:w-[300px] text-[32px] md:text-[30px] leading-tight text-center mx-auto">“Abadikan setiap Moment berhargamu”</h1>
        </div>
        ...
        <div className="w-full md:w-1/2">
          <form action="">
            ...
            {/* Category */}
            <div className="relative w-full mt-5">
              <select className="w-full px-10 py-3 bg-[#393f17] text-white border border-[#D48319] rounded focus:outline-none appearance-none">
                <option value="category1" className="bg-[#393f17]">
                  Wedding
                </option>
                <option value="category2" className="bg-[#393f17]">
                  Graduation
                </option>
                <option value="category3" className="bg-[#393f17]">
                  Event Documentation
                </option>
              </select>
              <span className="absolute left-3 top-1/2 transform -translate-y-1/2 text-[#D48319]">
